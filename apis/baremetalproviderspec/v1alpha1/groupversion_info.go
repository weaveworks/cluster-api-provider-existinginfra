...
// Package v1alpha1 contains API Schema definitions for the baremetalproviderspec v1alpha1 API group
// +kubebuilder:object:generate=true
// +groupName=baremetalproviderspec
package v1alpha1
...
var (
	...
	// localSchemeBuilder is a pointer to the runtime.SchemeBuilder used to add known types and conversions.
